...
const UpdateProduct = () => {
  ...
  const [form, setForm] = useState({ name: "", description: "", price: "", category: "", quantity: "", image: "", productId: "" });
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      <div className="w-full rounded-xl border border-white/10 bg-slate-900/70 py-3 pl-11 pr-4 text-white cursor-pointer transition hover:border-brand-500">
                        {form.image ? (
                      ...
                      <p className="mt-2 text-xs text-slate-500">
                        Leave empty to keep current image. JPG, PNG, GIF (Max 5MB)
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-xl">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">
                      Live preview of the updated product
                    </p>
                  </div>
                </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-gradient-to-r from-brand-500/10 via-cyan-500/10 to-indigo-500/10 p-6 shadow-2xl backdrop-blur-xl">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  Update the product details accurately. Fields marked with * are required. Images are optional - leave blank to keep the current image.
                </p>
              </div>
            </div>
          </div>
